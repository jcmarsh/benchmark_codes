...
/* Modified for simulated radiation test on the Zybo */
...
// TODO: look into adding output of some sort
// TODO: possibly remove some of the benchmarks

	xil_printf("\r\n");

	xil_printf("Loops: %ld, Iterations: %d\r\n", LOOP, II);
...
{
	xil_printf("%7ld %7ld %7ld %12.4e %12.4e %12.4e %12.4e\n",
						N, J, K, X1, X2, X3, X4);
}
#endif
